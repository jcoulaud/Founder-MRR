...
export default function RisingStars({ data }: Props) {
  ...
  return (
    <div className="mb-6">
      <div className="rounded-xl bg-gradient-to-br from-amber-50 via-amber-50/50 to-white border border-amber-100 p-5 md:p-6">
        <h3 className="font-display font-bold text-sm text-amber-800 mb-4 flex items-center gap-2">
          ...
          {stars.map((entry, i) => (
            ...
            >
              ...
              <div className="flex items-baseline justify-between">
                <span className="font-mono text-xl font-semibold text-emerald-600 tabular-nums">
